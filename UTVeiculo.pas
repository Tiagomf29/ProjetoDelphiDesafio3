...
type
  ...
  public
    ...
    function buscaVeiculo(id : Integer):TObjectList<TVeiculo> ;overload;
    function buscaVeiculo(modelo : String):TObjectList<TVeiculo> ; overload;
...
function TVeiculo.buscaVeiculo(id: Integer): TObjectList<TVeiculo>;
var
    ...
    qry.Connection := dm.conexao;
     ...
     while not qry.Eof do
       begin
         ...
         tipoVeiculo.id := qry.FieldByName('idTipoVeiculo').AsInteger;
         veiculo.tipoVeiculo := tipoVeiculo;
         veiculo.ocupantes := qry.FieldByName('v.ocupantes').AsInteger;
...
function TVeiculo.buscaVeiculo(modelo: String): TObjectList<TVeiculo>;
var
lista : TObjectList<TVeiculo>;
veiculo : TVeiculo;
tipoVeiculo : TTipoVeiculo;
